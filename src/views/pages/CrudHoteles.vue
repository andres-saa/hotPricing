                ...
                >
                    ...
                    <Column field="hotelname" header="Name" :sortable="true" headerStyle="width:14%; min-width:10rem;">
                        <template #body="slotProps">
                            ...
                            {{ slotProps.data.hotelname }}
                        </template>
                    </Column>
                    <Column header="Image" headerStyle="width:14%; min-width:10rem;">
                        <template #body="slotProps">
                            <span class="p-column-title">Image</span>
                            <img :src="convertir(slotProps.data.imagen_uno).src" :alt="slotProps.data.image" class="shadow-2" width="100" />
                        </template>
                    </Column>
                    <Column field="precio_ahora" header="precio" :sortable="true" headerStyle="width:14%; min-width:8rem;">
                        <template #body="slotProps">
                            <span class="p-column-title">precio</span>
                            {{ formatearPesos(slotProps.data.precio_ahora)  }}
                        </template>
                    </Column>
                    <Column field="ciudad" header="Ciudad" :sortable="true" headerStyle="width:14%; min-width:10rem;">
                        <template #body="slotProps">
                            <span class="p-column-title">ciudad </span>
                            {{ slotProps.data.ciudad }}
                        </template>
                    </Column>
                    <Column field="rating" header="Calificacion" :sortable="true" headerStyle="width:14%; min-width:10rem;">
                        <template #body="slotProps">
